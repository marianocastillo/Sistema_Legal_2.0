...
@media (max-width: 768px) {
    ...
    .welcome-section {
        ...
        border-radius: 10px 10px 0 0; /* Ajustar el borde */
        padding: 20px; /* Reducir el padding */
    }

    .login-section {
        width: 100%; /* Hacer que ocupe todo el ancho */
        border-radius: 0 0 10px 10px; /* Ajustar el borde */
        padding: 20px; /* Reducir el padding */
    }
...
@media (min-width: 769px) and (max-width: 1024px) {
    .login-container {
        ...
        max-width: 800px; /* Ancho máximo para pantallas medianas */
        height: 400px;
    }
    ...
    .logo img {
        width: 240px; /* Ajustar el tamaño del logo */
        height: auto; /* Mantener la proporción */
    }
}
...
@media (min-width: 1025px) {
    .login-container {
        width: 70%; /* Ancho mayor para pantallas grandes */
    ...
    .welcome-section,
    .login-section {
        padding: 40px; /* Mantener el padding */
    }

    .logo img {
        width: 270px; /* Mantener el tamaño del logo */
        height: 250px;
    }
}
.password-container {
    position: relative; /* Asegura que el icono esté dentro del input */
}

.password-container input {
    padding-right: 40px; /* Añade espacio para el icono dentro del input */
}
...
.password-icon:hover {
    color:#013579; /* Cambia de color al hacer hover */
}
