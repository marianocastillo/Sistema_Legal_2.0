<template>
  <div class="card p-6 shadow-2">
    <div class="flex justify-content-between align-items-center mb-2">
      <h2 class="text-2xl font-semibold">Agregar usuarios</h2>
    ...
    <div class="formgrid grid">
      ...
      <div class="field col-12 md:col-4">
        <span class="p-float-label">
          <Calendar id="fechaActo" v-model="form.fechaActo" dateFormat="dd/mm/yy" class="w-full" placeholder="Fecha del acto "/>
        </span>
      </div>

      <div class="field col-12 md:col-4">
        <span class="p-float-label">
          <InputText id="cedulaDemandante" v-model="form.cedulaDemandante" class="w-full"  placeholder="Cédula del demandante"/>
      ...
      <div class="field col-12 md:col-4">
        <span class="p-float-label">
          <InputText id="cedulaRepresentante" v-model="form.cedulaRepresentante" class="w-full" placeholder="Cédula del representante"/>
      ...
      <div class="field col-12 md:col-4">
        <span class="p-float-label">
          <Dropdown id="tribunal" v-model="form.tribunal" :options="tribunales" optionLabel="label" class="w-full w-full p-dropdown" placeholder="Tribunal" />
      ...
      <div class="field col-12 md:col-6">
        <span class="p-float-label">
          <InputText id="nombreRepresentante" v-model="form.nombreRepresentante" class="w-full" placeholder="Nombre del representante" />
      ...
      <div class="field col-12 md:col-3">
        <span class="p-float-label">
          <Calendar id="fechaAudiencia" v-model="form.fechaAudiencia" dateFormat="dd/mm/yy" class="w-full" placeholder="Fecha de audiencia" />
      ...
      <div class="field col-12 md:col-3">
        <span class="p-dropdown">
          <Dropdown id="estatus" v-model="form.estatus" :options="estatusList" optionLabel="label" class="w-full p-dropdown mb-2" placeholder="Estatus" />
      ...
      <div class="field col-4 align-left">
        ...
        <FileUpload mode="basic" name="otros" url="/api/upload" accept=".pdf,.doc,.docx" auto
    ...
    <div class="flex justify-content-center mt-4">
      <Button label="Actualizar Litigio" icon="pi pi-check" class="p-button-success" @click="registrarLitigio" />
    </div>
  </div>
</template>
...
.p-float-label {
  ...
  border-color: #ccc !important; /* Borde gris claro */
}

/* Asegura que las etiquetas también sean de color negro */
.p-float-label label {
  color: #000000 !important; /* Color de texto negro para las etiquetas */
}
...
.p-multiselect:focus {
  border-color: #007bff !important; /* Color de borde azul al enfocarse */
