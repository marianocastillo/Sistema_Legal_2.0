    ...
    <div class="card p-6 shadow-2">
      ...
      <div class="formgrid grid">
        ...
        <div class="field col-12">
          ...
          <FileUpload mode="basic" name="otros" url="/api/upload" accept=".pdf,.doc,.docx" auto chooseLabel="Otros documentos" class="mt-2" />
        </div>
      </div>
  
      <div class="flex justify-content-end mt-4">
        <Button label="Registrar" icon="pi pi-check" class="p-button-success" @click="registrarLitigio" />
      </div>
    </div>
  </template>
